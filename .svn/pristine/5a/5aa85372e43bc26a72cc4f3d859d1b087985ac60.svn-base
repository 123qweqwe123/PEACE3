...
$(function() {
	...
	var option = {
			url : '${ctx}/progress/reportProgresslist',
			postData :o ,
			datatype : 'json',
			mtype : 'POST',
			colNames : [ '项目点编码', '项目点名称', '完成人数' ,'完成率', '检出人数', '检出率', '完成人数', '完成率',
					'完成人数','完成率','完成人数','完成率','完成人数','所占比例' ],
			colModel : [
					{
						name : 'LCC_CODE'
					},
			...
			loadComplete : function() {
				...
				var _data = {'LCC_CODE':' ','LCC_NAME':'合计/统计','UQS2':0,'UQS34':0,'RISK':0,'UQS5':0,'UQS6':0,'INTERVIEW':0};
		...
		$('#exportQuery').click(function(){
			var url = './exportexcel?template=progress';
			if ( $('#bg_date').val() != '')
