...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            ...
            window.open('${ctx}/qn/eventMgt/checkEvents1/download' + pram);
        }
    ...
    $(function () {
        ...
        $("#importEvent").click(function () {
            var options = {
                ...
                callback: function () {
                    $.post("${ctx}/qn/eventMgt/checkEvents1/updateEventCheckStatus", {eventCodeList: $("#eventCodeList").val()}, function (data) {
                       if(data) {
                           setTimeout(function () {
                               var option1 = {
                                   title: '添加待审核事件',
        ...
        var option = {
            url: '${ctx}/qn/eventMgt/checkEvents1/getCheckEvents',
            datatype: 'json',
            mtype: 'POST',
            ...
            colModel: [
                {
                    ...
                    var url = "${ctx}/qn/eventMgt/checkEvents1/check?eventCode=" + c;
