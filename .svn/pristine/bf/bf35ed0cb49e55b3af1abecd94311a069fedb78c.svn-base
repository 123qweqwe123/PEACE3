var defaultOptions= {
    locale: 'zh',  // 'en','zh','es','pt',‘fr','de','ar','ru','it','nl','el','he','hi','hu','sv','ko','ja'
    ...
    uiFlags: {
        ...
        aboutBtn: 0, // show/hide "About" button: 1/0
    ...
    chart:{
        ...
        high:{
            ...
            chart:{
                type:'column'  //column, bar, line, spline, area, areaspline
            },
            credits: {
                enabled:false
            },
