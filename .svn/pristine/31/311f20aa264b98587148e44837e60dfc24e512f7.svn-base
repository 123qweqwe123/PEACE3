...
public interface DeviceDao {
	...
	/**
	 * 
	 * description:通过设备编号和项目project_id查找
	 * 
	 * @author yangfeng
	 * @param masterIn
	 * @return
	 * @update 2015-12-17
	 */
	public MasterImportDetail selectImportMasterDetailByArchivesNoProjectId(
			Map map);
	...
	public void deleteMaterStore(MaterStore ms);
	 ...
	 * @update 2015-12-10
	 */
	public void insertMaterStore1(MaterStore ms);
	/**
	 * 通过订单号查询出库表信息
	 * @param exportNos
	 * @return
	...
	public MasterImport selectMasterImportByImorderNo(MaterImportFilter filter);
	
	public MaterExport selectMaterExportByExorderNo(@Param("exorderNo")String exorderNo);
}
