...
(function () {
   ...
   // var URL = window.UEDITOR_HOME_URL || getUEBasePath();
	  var URL = publicPath + "/static/ueditor1.3.6/";	 
	  var uploadURL = publicPath + "/static/ueditor1.3.6/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath: uploadURL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
