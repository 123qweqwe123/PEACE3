package com.bdcor.pip.web.pro.promgt.service.patientExcelResolving;
...
public class ExcelDataTransToObjWithPOI {
	...
	private void findSheet() throws ExcelDataException{
		...
		this.excelHelper = new ExcelHelper(this.sheet,this.book);
	}
	...
	private String templeteType(Sheet sh){
		ExcelHelper eHelper = new ExcelHelper(sh, null);
