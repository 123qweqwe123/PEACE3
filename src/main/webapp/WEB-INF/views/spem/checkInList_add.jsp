...
<ul class="breadcrumb">
	...
	<div style="width: 75%;margin:0 auto;" >
		...
		<div class="row">
			...
			<div class="col-md-5">
				<input type="hidden" name="fridgeId" id="fridgeId" value="${vo.fridgeId}"/>
				<input type="text" name="fridgeName" id="fridge_name" value="${vo.fridgeName}">
			</div>
		</div>
		...
		<input type="hidden" name="boxTypes" id="boxTypes"/>
		</form>
		<div class="row">
...
$('#btnBack').click(function(){
    location.href="${ctx}/spem/checkInList/init"
});
...
$('#btnSureAndNext').click(function(){
	...
	if(confirm("确认提交吗？")){
		...
		$("#boxTypes").val(boxTypes);
		var form = $("#subForm")[0];
		form.action="${ctx}/spem/checkInList/toPreview";
		form.submit();
	}
});
var date=new Date();
