...
<body>
	...
	<div style="width: 75%;margin:0 auto;" >
		...
		<div class="row">
			<div class="col-md-7 col-md-offset-5">
				<button type="button" id="btnModify" class="btn btn-primary btn-sm">修改</button>
	...
	<form action="" id="subForm" method="post">
		<input type="hidden" name="checkInListId" value="${vo.id}">
	</form>
...
$('#btnModify').click(function(){
		var form = $("#subForm")[0];
		form.action="${ctx}/spem/checkInList/toModify";
		form.submit();
});
