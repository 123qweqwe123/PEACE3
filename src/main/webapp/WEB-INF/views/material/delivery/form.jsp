...
<c:set var="ctx" value="${pageContext.request.contextPath}" />
    ...
    <form id="export_form" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-lg-4 col-md-3  control-label" for="activeclassCode"><span style="color: red">*</span>出库类别${mat.activeclassCode}:</label>
			<div class="col-lg-7 col-md-8">
			...
			$("#export_form").validate({
				rules: {
					...
					exorderNo:{
						...
						remote:{
							type:"POST",
							url:'${ctx}/material/delivery/checkexorderNoExists',
							dataType:'json',
							data:{
								exorderNo:function(){
