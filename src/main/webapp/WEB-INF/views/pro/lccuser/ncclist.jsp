...
<body>
	...
	<script type="text/javascript">
		...
		function toAdd(){
			...
			openDialog("${ctx}/pro/lccuser/openmodallccuserinput?lccRoleType=1&time="+timebak);
		}	
		function toModify(){
			...
			var timebak = new Date().getTime();
			openDialog("${ctx}/pro/lccuser/openmodallccuserinput?lccRoleType=1&userCode="+userCode+"&time="+timebak);
		}
		...
		function outExcelLccUser(){
			...
			window.location.href ='${ctx}/pro/lccuser/outExcelLccUser?lccRoleType=1';
		}
