...
<c:set var="ctx" value="${pageContext.request.contextPath}" />
	<form id="user_form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-5">
                <input type="text" id="loginName" name="loginName" class="form-control input-sm"  value="${user.loginName}" placeholder="登录名" required>
            </div>
        </div>
        <!-- 
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-lg-3 col-md-3  control-label" for="lccname"><span style="color: red">*</span>用户名:</label>
			<div class="col-lg-5 col-md-5">
				<input type="text" id="lccname1" name="lccname" value="${user.lccname}" class="form-control input-sm hhh" placeholder="可输入用户名称简码" autocomplete="off" required readonly>
			</div>
		</div>
		
		<input id="name2" name="name" value="${user.name}" type="hidden"/>
		...
		<input id="lccCode2" name="lccCode" value="${user.lccCode}" type="hidden"/>
	...
	<script>
		$(function(){
			  ...
			  $("#loginName").val('${pyName}');	
			  $("#name2").val('${hiddenname}');	
		      $("#lccname1").val('${hiddenname}');		
			  $("#lccCode2").val('${hiddenLccCode}');
			  $("#projectId").val('${projectId}');
			  $("#userCode").val('${userCode}');
			/**
			$("#loginName").val('${user2.loginName}');	
			$("#name2").val('${user2.name}');	
			$("#lccname1").val('${user2.name}');		
			$("#lccCode2").val('${user2.lccCode}');
			$("#projectId").val('${projectId}');
			**/
